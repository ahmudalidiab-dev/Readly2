...
public class FirebaseServices {
    ...
    public boolean updateUser(@SuppressLint("RestrictedApi") User user)
    {
        ...
        @SuppressLint("RestrictedApi") String firstNameValue = user.getUid();
        String lastNameFieldName = "lastName";
        @SuppressLint("RestrictedApi") Class<? extends User> lastNameValue = user.getClass();
        String usernameFieldName = "username";
        @SuppressLint("RestrictedApi") String usernameValue = user.getUid();
        ...
        @SuppressLint("RestrictedApi") String phoneValue = user.getUid();
